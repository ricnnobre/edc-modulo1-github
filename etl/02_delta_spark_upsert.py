...
enemnovo = (
    ...
    .load("s3://datalake-igti-m1-terraform-producao-945696890928/staging/enem")
)
...
enemvelho = DeltaTable.forPath(spark, "s3://datalake-igti-m1-terraform-producao-945696890928/staging/enem")
