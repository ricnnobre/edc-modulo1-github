...
enemnovo = (
    ...
    .load("s3://datalake-igti-m1-terraform-producao-945696890928/staging/enem/2020")
)
...
enemvelho = DeltaTable.forPath(spark, "s3://datalake-igti-m1-terraform-producao-945696890928/staging/enem/2020")
